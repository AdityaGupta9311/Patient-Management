...
public class PatientController {
	...
	public ResponseEntity<PatientResponseDTO> createPatient(@Validated({ Default.class,
			CreatePatientValidationGroup.class }) @RequestBody PatientRepuestDTO patientRepuestDTO) {
		PatientResponseDTO patientResponseDTO = patientService.createPatient(patientRepuestDTO);
	...
	public ResponseEntity<PatientResponseDTO> updatePatient(@PathVariable UUID id,
			@Validated({Default.class }) @RequestBody PatientRepuestDTO patientRepuestDTO) {
		PatientResponseDTO patientResponseDTO = patientService.updatePatient(id, patientRepuestDTO);
		return ResponseEntity.ok().body(patientResponseDTO);
	}
